...
function CreateNeutralHostile takes nothing returns nothing
    ...
    set u = BlzCreateUnitWithSkin( p, 'd115', 8850.8, 10822.5, 174.284, 'd115' )
    set u = BlzCreateUnitWithSkin( p, 'd115', 10534.8, -5082.3, 33.125, 'd115' )
    set u = BlzCreateUnitWithSkin( p, 'd115', 7107.5, -7624.0, 319.065, 'd115' )
    set u = BlzCreateUnitWithSkin( p, 'd115', 3594.4, 10844.1, 56.200, 'd115' )
    set u = BlzCreateUnitWithSkin( p, 'd115', -10657.6, -5648.6, 307.022, 'd115' )
endfunction
...
function CreateNeutralPassiveBuildings takes nothing returns nothing
    ...
    set u = BlzCreateUnitWithSkin( p, 'd106', 8000.0, -4416.0, 270.000, 'd106' )
    ...
    set u = BlzCreateUnitWithSkin( p, 'd107', 5696.0, -4224.0, 270.000, 'd107' )
    ...
    set u = BlzCreateUnitWithSkin( p, 'd001', 7872.0, -8064.0, 270.000, 'd001' )
    set u = BlzCreateUnitWithSkin( p, 'd105', -6336.0, 1984.0, 270.000, 'd105' )
    set u = BlzCreateUnitWithSkin( p, 'd001', -5952.0, 3904.0, 270.000, 'd001' )
    set u = BlzCreateUnitWithSkin( p, 'd001', 4288.0, 8768.0, 270.000, 'd001' )
    ...
    set u = BlzCreateUnitWithSkin( p, 'd001', -4928.0, -6336.0, 270.000, 'd001' )
    ...
    set u = BlzCreateUnitWithSkin( p, 'd108', -7808.0, 2624.0, 270.000, 'd108' )
    ...
    set u = BlzCreateUnitWithSkin( p, 'd108', 5184.0, 6848.0, 270.000, 'd108' )
    set u = BlzCreateUnitWithSkin( p, 'd108', 6016.0, -7296.0, 270.000, 'd108' )
    set u = BlzCreateUnitWithSkin( p, 'd108', -3008.0, -8064.0, 270.000, 'd108' )
    set u = BlzCreateUnitWithSkin( p, 'd101', -7296.0, 7104.0, 270.000, 'd101' )
    set u = BlzCreateUnitWithSkin( p, 'd101', -5312.0, 7104.0, 270.000, 'd101' )
    set u = BlzCreateUnitWithSkin( p, 'd103', 6208.0, 5952.0, 270.000, 'd103' )
    set u = BlzCreateUnitWithSkin( p, 'd103', 5056.0, 6080.0, 270.000, 'd103' )
    set u = BlzCreateUnitWithSkin( p, 'd109', 7744.0, -4928.0, 270.000, 'd109' )
    ...
    set u = BlzCreateUnitWithSkin( p, 'd107', -9408.0, -6720.0, 270.000, 'd107' )
    ...
    set u = BlzCreateUnitWithSkin( p, 'd102', 8576.0, 448.0, 270.000, 'd102' )
    set u = BlzCreateUnitWithSkin( p, 'd102', 6208.0, -1216.0, 270.000, 'd102' )
    ...
    set u = BlzCreateUnitWithSkin( p, 'd100', -7168.0, -1664.0, 270.000, 'd100' )
    set u = BlzCreateUnitWithSkin( p, 'd100', -2880.0, 7360.0, 270.000, 'd100' )
    set u = BlzCreateUnitWithSkin( p, 'd100', -4288.0, 3264.0, 270.000, 'd100' )
    ...
    set u = BlzCreateUnitWithSkin( p, 'd100', 8256.0, -3136.0, 270.000, 'd100' )
    ...
    set u = BlzCreateUnitWithSkin( p, 'd001', -5632.0, 1088.0, 270.000, 'd001' )
    ...
    set u = BlzCreateUnitWithSkin( p, 'd001', -4672.0, -64.0, 270.000, 'd001' )
    ...
    set u = BlzCreateUnitWithSkin( p, 'd108', 7616.0, 3520.0, 270.000, 'd108' )
    set u = BlzCreateUnitWithSkin( p, 'd100', 9024.0, 6272.0, 270.000, 'd100' )
    ...
    set u = BlzCreateUnitWithSkin( p, 'd108', -5056.0, -192.0, 270.000, 'd108' )
    ...
    set u = BlzCreateUnitWithSkin( p, 'd105', -5440.0, -2944.0, 270.000, 'd105' )
    set u = BlzCreateUnitWithSkin( p, 'd105', 1856.0, -832.0, 270.000, 'd105' )
    set u = BlzCreateUnitWithSkin( p, 'd100', -3008.0, -6592.0, 270.000, 'd100' )
    set u = BlzCreateUnitWithSkin( p, 'd001', 8896.0, -2112.0, 270.000, 'd001' )
    set u = BlzCreateUnitWithSkin( p, 'd102', -960.0, 4800.0, 270.000, 'd102' )
    set u = BlzCreateUnitWithSkin( p, 'd105', 6080.0, -5952.0, 270.000, 'd105' )
    set u = BlzCreateUnitWithSkin( p, 'd105', 2112.0, 7104.0, 270.000, 'd105' )
...
function CreateRegions takes nothing returns nothing
    ...
    set gg_rct_fish_new_7 = Rect( 8384.0, -9600.0, 9056.0, -8736.0 )
    ...
    set gg_rct_spawn_area_3_1 = Rect( 5024.0, -9440.0, 9184.0, -928.0 )
    set gg_rct_spawn_area_3_2 = Rect( 736.0, -9792.0, 2272.0, -5248.0 )
    set gg_rct_spawn_area_3_3 = Rect( 2240.0, -9760.0, 5056.0, -2752.0 )
    ...
    set gg_rct_Pantsu_Waterfall_Left_In = Rect( 7008.0, -8448.0, 7328.0, -8288.0 )
    set gg_rct_Pantsu_Waterfall_Left_Out = Rect( 7040.0, -8928.0, 7328.0, -8800.0 )
    set gg_rct_Pantsu_Waterfall_Right_In = Rect( 7776.0, -7840.0, 7936.0, -7520.0 )
